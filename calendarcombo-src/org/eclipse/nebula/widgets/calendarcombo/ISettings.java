...
public interface ISettings
{
	...
	/**
	 * Returns if the combo can have am empty date and text. If this is false, empty values will be replaced by the default date. 
	 */
	public boolean allowEmptyDate();
	
	/**
	 * Returns the default date used if allowEmptyDate is false.  
	 */
