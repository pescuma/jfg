...
public class ObjectReflectionGroupTest
{
	...
	public void testWithPublicFields()
	{
		...
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithPublicFields.aa", attr.getName());
		...
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithPublicFields.bb", attr.getName());
		...
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithPublicFields.cc", attr.getName());
	...
	public void testWithPublicFieldsAndGettersSetters()
	{
		...
		assertSimpleFieldAttribute(obj, int.class);
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithPublicFieldsAndGettersSetters.aa", attr.getName());
		...
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithPublicFieldsAndGettersSetters.bb", attr.getName());
		...
		assertSimpleFieldAttribute(obj, String.class);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithPublicFieldsAndGettersSetters.cc", attr.getName());
		assertEquals(null, attr.getValue());
		tc.cc = "x";
		assertEquals("x", attr.getValue());
		attr.setValue("y");
	...
	public void testWithOnlyMethods()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithOnlyMethods.aa", attr.getName());
		assertEquals(Integer.valueOf(0), attr.getValue());
		tc.setAa(1);
		assertEquals(Integer.valueOf(1), attr.getValue());
		attr.setValue(Integer.valueOf(2));
		...
		assertSimpleFieldAttribute(obj, long.class);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithOnlyMethods.bb", attr.getName());
		assertEquals(Long.valueOf(0), attr.getValue());
		tc.setBb(1);
		assertEquals(Long.valueOf(1), attr.getValue());
		attr.setValue(Long.valueOf(2));
		...
		assertSimpleFieldAttribute(obj, String.class);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithOnlyMethods.cc", attr.getName());
		assertEquals(null, attr.getValue());
		tc.setCc("x");
		assertEquals("x", attr.getValue());
		attr.setValue("y");
	...
	static void testWithEverything(TestClassWithEverything tc, AttributeGroup group)
	{
		...
		assertSimpleFieldAttribute(obj, int.class);
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithEverything.aa", attr.getName());
		assertEquals(Integer.valueOf(100), attr.getValue());
		tc.aa = 1;
		assertEquals(Integer.valueOf(101), attr.getValue());
		attr.setValue(Integer.valueOf(2));
		...
		assertSimpleFieldAttribute(obj, long.class);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithEverything.bb", attr.getName());
		assertEquals(Long.valueOf(0), attr.getValue());
		tc.setBb(1);
		assertEquals(Long.valueOf(1), attr.getValue());
		attr.setValue(Long.valueOf(2));
		...
		assertSimpleFieldAttribute(obj, String.class);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithEverything.cc", attr.getName());
		assertEquals(null, attr.getValue());
		tc.setCc("x");
		assertEquals("x", attr.getValue());
		attr.setValue("y");
	...
	public void testWithExtends()
	{
		...
		assertSimpleFieldAttribute(obj, int.class);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithExtends.dd", attr.getName());
		assertEquals(Integer.valueOf(0), attr.getValue());
		tc.dd = 1;
		assertEquals(Integer.valueOf(1), attr.getValue());
		attr.setValue(Integer.valueOf(2));
		...
		assertSimpleFieldAttribute(obj, long.class);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithExtends.ee", attr.getName());
		assertEquals(Long.valueOf(0), attr.getValue());
		tc.setEe(1);
		assertEquals(Long.valueOf(1), attr.getValue());
		attr.setValue(Long.valueOf(2));
	...
	public void testWithFieldListener()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithFieldListener.aa", attr.getName());
	...
	public void testWithStrangeFieldListener()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithStrangeFieldListener.aa", attr.getName());
		assertEquals(true, attr.canWrite());
		assertEquals(long.class, attr.getType());
	...
	public void testWithWrongFieldListener()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithWrongFieldListener.aa", attr.getName());
		assertEquals(true, attr.canWrite());
		assertEquals(long.class, attr.getType());
	...
	public void testWithGroupListener()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithGroupListener.aa", attr.getName());
		assertEquals(true, attr.canWrite());
		assertEquals(long.class, attr.getType());
		...
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithGroupListener.bb", attr.getName());
		assertEquals(true, attr.canWrite());
		assertEquals(long.class, attr.getType());
	...
	public void testAsGroup()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithOther.aa", attr.getName());
		assertEquals(true, attr.canWrite());
	...
	public void testWithPublicEnum()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithEnum.aa", attr.getName());
	...
	public void testWithAnnotations()
	{
		...
		Attribute attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithAnnotations.aa", attr.getName());
		AttributeValueRange range = attr.getValueRange();
		assertFalse(range.canBeNull());
		assertNull(range.getMin());
		assertNull(range.getMax());
		...
		assertFieldAttribute(obj, true, false, false, true);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithAnnotations.bb", attr.getName());
		...
		assertFieldAttribute(obj, true, false, false, true);
		attr = (Attribute) obj;
		assertEquals("jfg.reflect.ObjectReflectionGroupTest$TestClassWithAnnotations.cc", attr.getName());
		range = attr.getValueRange();
		assertTrue(range.canBeNull());
		assertNull(range.getMin());
		assertNull(range.getMax());
